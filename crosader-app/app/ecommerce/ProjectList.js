                ...
                <div className="row project-list-showcase">
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      <div className="d-flex align-items-start">
                        ...
                        <div className="badge badge-success ms-auto">
                          Finished
                        </div>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      <div className="d-flex align-items-start">
                        ...
                        <div className="badge badge-info ms-auto">On going</div>
                      </div>
                      <p className="project-description">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor.
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    ...
                    <div className="project-grid-inner">
                      <div className="d-flex align-items-start">
                        ...
                        <div className="badge badge-danger ms-auto">Hold</div>
                      </div>
                      <p className="project-description">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor.
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      <img
                        ...
                        src={"/assets/images/brand_icons/bitmap.jpg"}
                        alt="brand"
                      />
                      <div className="d-flex align-items-start">
                        <div className="wrapper">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      <img
                        className="mb-3 mt-n3"
                        src={"/assets/images/brand_icons/oval-copy.jpg"}
                        alt="profile"
                      />
                      <div className="d-flex align-items-start">
                        <div className="wrapper">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      <img
                        className="mb-3 mt-n3"
                        src={"/assets/images/brand_icons/oval.jpg"}
                        alt="brand"
                      />
                      <div className="d-flex align-items-start">
                        <div className="wrapper">
