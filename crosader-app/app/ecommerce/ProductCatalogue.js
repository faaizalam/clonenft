                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            ...
                            src={
                              "/assets/images/product_images_2/thumb_image12.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
                        ...
                        <p className="product-description">
                          Product Dimensions: Length (13 Inches) Width
                          (13Inches) & Height (30 Inches).
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            className="product_image"
                            src={
                              "/assets/images/product_images_2/thumb_image1.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            className="product_image"
                            src={
                              "/assets/images/product_images_2/thumb_image2.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
                        ...
                        <p className="product-description">
                          Power Capability: 150mW Cable Length: 1.5 meter
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            className="product_image"
                            src={
                              "/assets/images/product_images_2/thumb_image3.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            className="product_image"
                            src={
                              "/assets/images/product_images_2/thumb_image4.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            className="product_image"
                            src={
                              "/assets/images/product_images_2/thumb_image5.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            className="product_image"
                            src={
                              "/assets/images/product_images_2/thumb_image6.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            className="product_image"
                            src={
                              "/assets/images/product_images_2/thumb_image7.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            className="product_image"
                            src={
                              "/assets/images/product_images_2/thumb_image8.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            className="product_image"
                            src={
                              "/assets/images/product_images_2/thumb_image9.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            className="product_image"
                            src={
                              "/assets/images/product_images_2/thumb_image10.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="product-img-outer">
                          <img
                            className="product_image"
                            src={
                              "/assets/images/product_images_2/thumb_image11.jpg"
                            }
                            alt="prduct"
                          />
                        </div>
