...
const initialData = {
  tasks: {
    "task-1": {
      ...
      date: "20 Feb 2019",
      img1URL: "/assets/images/faces/face8.jpg",
      img2URL: "/assets/images/faces/face9.jpg",
      img3URL: "/assets/images/faces/face10.jpg",
      priority: "important",
      dueDate: "Due 10 days",
    ...
    "task-2": {
      ...
      taskName: "Server gateway",
      date: "20 Feb 2019",
      img1URL: "/assets/images/faces/face23.jpg",
      img2URL: "/assets/images/faces/face24.jpg",
      img3URL: "/assets/images/faces/face25.jpg",
      priority: "important",
      dueDate: "Due 10 days",
    ...
    "task-3": {
      ...
      date: "20 Feb 2019",
      img1URL: "/assets/images/faces/face15.jpg",
      img2URL: "/assets/images/faces/face16.jpg",
      img3URL: "/assets/images/faces/face17.jpg",
      priority: "important",
      dueDate: "Due 10 days",
    ...
    "task-4": {
      ...
      taskName: "Director",
      date: "20 Feb 2019",
      img1URL: "/assets/images/faces/face14.jpg",
      img2URL: "/assets/images/faces/face15.jpg",
      img3URL: "/assets/images/faces/face16.jpg",
      priority: "important",
      dueDate: "Due 10 days",
    ...
    "task-5": {
      ...
      date: "20 Feb 2019",
      img1URL: "/assets/images/faces/face5.jpg",
      img2URL: "/assets/images/faces/face6.jpg",
      img3URL: "/assets/images/faces/face7.jpg",
      priority: "important",
      dueDate: "Due 10 days",
      progressVariant: "danger",
    },
                ...
                <div className="d-flex flex-column flex-md-row align-items-center flex-wrap justify-content-between">
                  ...
                  <div className="wrapper d-none d-lg-flex  align-items-center my-2">
                    <div className="image-grouped ml-md-4">
                      <img src={"/assets/images/faces/face20"} alt="profile" />
                      <img src={"/assets/images/faces/face17"} alt="profile " />
                      <img src={"/assets/images/faces/face14"} alt="profile " />
                    </div>
                    <button type="button" className="btn btn-dark btn-fw ms-4">
                  ...
                  <div className="wrapper ml-md-auto  d-none d-lg-flex flex-column flex-md-row kanban-toolbar ml-md-0 my-2">
                    <div className="d-flex">
                      <button
                        type="button"
                        className="btn btn-icons btn-dark d-none d-lg-block"
                      >
