      ...
      <div>
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            >
              <i className="mdi mdi-menu me-0 icon-md"></i>
            </button>
              ...
              <div className="row mx-0">
                ...
                <div className="col-xl-3 d-none d-lg-block px-0 chat-sidebar">
                  <img
                    ...
                    src={"/assets/images/chat/profile_image"}
                    alt="profile"
                  />
                  <div className="px-4">
                    <div className="d-flex pt-4">
                      ...
                      <div className="badge badge-success mb-auto ms-auto">
                        Online
                      </div>
                    </div>
                    <div className="pt-3">
                    ...
                    <div className="row">
                      <div className="col-4">
                        <img
                          ...
                          src={"/assets/images/chat/thumb_image1"}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={"/assets/images/chat/thumb_image2"}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={"/assets/images/chat/thumb_image3"}
                          alt="thumb"
                        />
                      </div>
                    </div>
                    <div className="row my-4">
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={"/assets/images/chat/thumb_image4"}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={"/assets/images/chat/thumb_image5"}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={"/assets/images/chat/thumb_image6"}
                          alt="thumb"
                        />
                      </div>
                    </div>
                    <div className="row mb-4">
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={"/assets/images/chat/thumb_image7"}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={"/assets/images/chat/thumb_image8"}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
