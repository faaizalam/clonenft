                ...
                <ul className="profile-list">
                  <li className="profile-list-item">
                    ...
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      ...
                      <span className="pro-pic">
                        <img src={"/assets/images/faces/face1"} alt="user" />
                      </span>
                      <div className="user">
                  ...
                  <li className="profile-list-item">
                    ...
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      {" "}
                      <span className="pro-pic">
                        <img src={"/assets/images/faces/face2"} alt="user" />
                      </span>
                      <div className="user">
                  ...
                  <li className="profile-list-item">
                    ...
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      {" "}
                      <span className="pro-pic">
                        <img src={"/assets/images/faces/face20"} alt="user" />
                      </span>
                      <div className="user">
                  ...
                  <li className="profile-list-item">
                    ...
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      {" "}
                      <span className="pro-pic">
                        <img src={"/assets/images/faces/face12"} alt="user" />
                      </span>
                      <div className="user">
                  ...
                  <li className="profile-list-item">
                    ...
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      {" "}
                      <span className="pro-pic">
                        <img src={"/assets/images/faces/face25"} alt="user" />
                      </span>
                      <div className="user">
                  ...
                  <li className="profile-list-item">
                    ...
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      {" "}
                      <span className="pro-pic">
                        <img src={"/assets/images/faces/face10"} alt="user" />
                      </span>
                      <div className="user">
                  ...
                  <li className="profile-list-item">
                    ...
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      {" "}
                      <span className="pro-pic">
                        <img src={"/assets/images/faces/face23"} alt="user" />
                      </span>
                      <div className="user">
                  ...
                  <li className="profile-list-item">
                    ...
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      {" "}
                      <span className="pro-pic">
                        <img src={"/assets/images/faces/face11"} alt="user" />
                      </span>
                      <div className="user">
                  ...
                  <li className="profile-list-item">
                    ...
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      {" "}
                      <span className="pro-pic">
                        <img src={"/assets/images/faces/face9"} alt="user" />
                      </span>
                      <div className="user">
                ...
                <div className="col-md-12 mb-4 mt-4">
                  <div className="btn-toolbar">
                    <div className="btn-group">
                      ...
                      >
                        <i className="mdi mdi-share-alt text-primary me-1"></i>{" "}
                        Reply
                      </button>
                      <button
                        type="button"
                      ...
                      <button
                        ...
                        className="btn btn-sm btn-outline-secondary"
                      >
                        <i className="mdi mdi-share text-primary me-1"></i>
                        Forward
                      </button>
                    </div>
                    <div className="btn-group">
                      <button
                        ...
                        className="btn btn-sm btn-outline-secondary"
                      >
                        <i className="mdi mdi-attachment text-primary me-1"></i>
                        Attach
                      </button>
                      <button
                        type="button"
                        className="btn btn-sm btn-outline-secondary"
                      >
                        <i className="mdi mdi-delete text-primary me-1"></i>
                        Delete
                      </button>
                    </div>
                  </div>
