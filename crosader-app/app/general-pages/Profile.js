                ...
                <div className="row">
                  <div className="col-lg-4">
                    ...
                    <div className="border-bottom py-4">
                      <p>Skills</p>
                      <div>
                        <label className="badge badge-outline-light me-1">
                          Chalk
                        </label>
                        <label className="badge badge-outline-light me-1">
                          Hand lettering
                  ...
                  <div className="col-lg-8">
                      ...
                      <ul className="nav profile-navbar">
                        ...
                        <li className="nav-item">
                          <a
                            ...
                            onClick={(event) => event.preventDefault()}
                          >
                            <i className="mdi mdi-newspaper me-1"></i>
                            Feed
                          </a>
                        </li>
                        <li className="nav-item">
                    ...
                    <div className="profile-feed">
                        ...
                        <div className="ms-4">
                          <h6>
                            ...
                            <small className="ms-4 text-muted">
                              <i className="mdi mdi-clock me-1"></i>10 hours
                            </small>
                          </h6>
                          <p>
                          ...
                          <p className="small text-muted mt-2 mb-0">
                            <span>
                              <i className="mdi mdi-star me-1"></i>4
                            </span>
                            <span className="ms-2">
                              <i className="mdi mdi-comment me-1"></i>11
                            </span>
                            <span className="ms-2">
                      ...
                      <div className="d-flex align-items-start profile-feed-item">
                        <img
                          src={"/assets/images/faces/face16"}
                          alt="profile"
                          className="img-sm rounded-circle"
                        />
                        <div className="ps-4">
                          ...
                          <img
                            src={"/assets/images/samples/1280x768/12"}
                            alt="sample"
                      ...
                      <div className="d-flex align-items-start profile-feed-item">
                        <img
                          src={"/assets/images/faces/face19"}
                          alt="profile"
                          className="img-sm rounded-circle"
                        />
                        <div className="ps-4">
                          ...
                          <img
                            src={"/assets/images/samples/1280x768/5"}
                            alt="sample"
                            className="rounded mw-100"
                          />
                          <p className="small text-muted mt-2 mb-0">
