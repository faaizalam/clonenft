                ...
                <div className="card-body">
                  <div className="clearfix">
                    ...
                    <div className="float-right">
                      <p className="mb-0 text-right text-light">
                        Total Revenue
                      </p>
                      <div className="fluid-container">
                        <h3 className="font-weight-medium text-right mb-0 text-light">
                          $6,560
                        </h3>
                      </div>
                    </div>
                  ...
                  <p className="text-muted mt-3 mb-0">
                    <i
                      className="mdi mdi-alert-octagon me-1"
                      aria-hidden="true"
                    ></i>{" "}
                    65% lower growth{" "}
                  </p>
            ...
            <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div className="card card-statistics">
                <div className="card-body">
                  ...
                  <p className="text-muted mt-3 mb-0">
                    <i
                      className="mdi mdi-bookmark-outline me-1"
                      aria-hidden="true"
                    ></i>{" "}
                    Product-wise sales{" "}
                  </p>
            ...
            <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div className="card card-statistics">
                <div className="card-body">
                  ...
                  <p className="text-muted mt-3 mb-0">
                    <i className="mdi mdi-calendar me-1" aria-hidden="true"></i>{" "}
                    Weekly Sales{" "}
                  </p>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div className="card card-statistics">
                <div className="card-body">
                  ...
                  <p className="text-muted mt-3 mb-0">
                    <i className="mdi mdi-reload me-1" aria-hidden="true"></i>{" "}
                    Product-wise sales{" "}
                  </p>
                </div>
              </div>
              ...
              <div className="card card-statistics">
                <div className="row">
                  <div className="card-col col-xl-3 col-lg-3 col-md-3 col-6">
                    <div className="card-body">
                      <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                        <i className="mdi mdi-account-multiple-outline text-primary me-0 mr-sm-4 icon-lg"></i>
                        <div className="wrapper text-center text-sm-left">
                          <p className="card-text mb-0 text-light">New Users</p>
                          <div className="fluid-container">
                            <h3 className="mb-0 font-weight-medium text-light">
                              65,650
                            </h3>
                          </div>
                        </div>
                  ...
                  <div className="card-col col-xl-3 col-lg-3 col-md-3 col-6">
                    <div className="card-body">
                      <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                        <i className="mdi mdi-checkbox-marked-circle-outline text-primary me-0 mr-sm-4 icon-lg"></i>
                        <div className="wrapper text-center text-sm-left">
                  ...
                  <div className="card-col col-xl-3 col-lg-3 col-md-3 col-6">
                    <div className="card-body">
                      <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                        <i className="mdi mdi-trophy-outline text-primary me-0 mr-sm-4 icon-lg"></i>
                        <div className="wrapper text-center text-sm-left">
                  ...
                  <div className="card-col col-xl-3 col-lg-3 col-md-3 col-6">
                    <div className="card-body">
                      <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                        <i className="mdi mdi-target text-primary me-0 mr-sm-4 icon-lg"></i>
                        <div className="wrapper text-center text-sm-left">
                          <p className="card-text mb-0 text-light">
                            Total Sales
                          </p>
          ...
          <div className="row">
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col-md-7">
                      ...
                      <h1 className="font-weight-medium mb-0 text-light">
                        $5998
                      </h1>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-xl-flex flex-row">
                    <img
                      src={"/assets/images/faces/face11"}
            ...
            <div className="col-md-4 grid-margin stretch-card">
              <div className="card">
                <div className="card-body">
                  <div className="d-xl-flex flex-row">
                    <img
                      src={"/assets/images/faces/face12"}
                      className="img-lg rounded"
                      alt="profile icon"
                    />
                    <div className="ml-xl-3 mt-2 mt-xl-0">
            ...
            <div className="col-md-4 grid-margin stretch-card">
              <div className="card">
                <img
                  ...
                  src={"/assets/images/dashboard/img_1"}
                  alt="card images"
                />
                <div className="card-body pb-0">
            ...
            <div className="col-md-4 grid-margin stretch-card">
              <div className="card">
                <img
                  className="card-img-top"
                  src={"/assets/images/dashboard/img_2"}
                  alt="card images"
                />
                <div className="card-body pb-0">
                  <p className="text-muted">
            ...
            <div className="col-md-4 grid-margin stretch-card">
              <div className="card">
                <img
                  className="card-img-top"
                  src={"/assets/images/dashboard/img_3"}
                  alt="card images"
                />
                <div className="card-body pb-0">
                  <p className="text-muted">
            ...
            <div className="col-md-4 grid-margin stretch-card">
              <div className="card aligner-wrapper">
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-center">
                    <h1 className="font-weight-medium mb-2 text-light">
                      $2,156
                    </h1>
                ...
                <div className="card-body no-gutter">
                  <div className="list-item">
                    <div className="preview-image">
                      <img
                        ...
                        src={"/assets/images/faces/face10"}
                        alt="profile icon"
                      />
                    </div>
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-auto">
                          <Rating
                            ...
                            emptySymbol={
                              <i
                                className="mdi mdi-star text-muted me-1"
                                style={{
                                  fontSize: "20px",
                                  marginRight: "2px",
                                  display: "block",
                            ...
                            fullSymbol={
                              <i
                                className="mdi mdi-star text-primary me-1"
                  ...
                  <div className="list-item">
                    <div className="preview-image">
                      <img
                        className="img-sm rounded-circle"
                        src={"/assets/images/faces/face13"}
                        alt="profile icon"
                      />
                    </div>
                    <div className="content">
                ...
                <div className="card-body">
                  ...
                  <div className="wrapper d-flex align-items-center py-2 border-bottom">
                    ...
                    <div className="wrapper ms-3">
                      <h6 className="ms-1 mb-1 text-light">Stella Davidson</h6>
                      <small className="text-muted mb-0">
                        <i className="mdi mdi-map-marker-outline me-1"></i>New
                        York City, USA
                      </small>
                    </div>
                  ...
                  <div className="wrapper d-flex align-items-center py-2 border-bottom">
                    ...
                    />
                    <div className="wrapper ms-3">
                      <h6 className="ms-1 mb-1 text-light">Daniel Russel</h6>
                      <small className="text-muted mb-0">
                  ...
                  <div className="wrapper d-flex align-items-center py-2 border-bottom">
                    ...
                    />
                    <div className="wrapper ms-3">
                      <h6 className="ms-1 mb-1 text-light">Bruno King</h6>
                      <small className="text-muted mb-0">
                        <i className="mdi mdi-map-marker-outline me-1"></i>
                        Arkansas, USA
                      </small>
                  ...
                  <div className="wrapper d-flex align-items-center py-2 border-bottom">
                    <img
                      className="img-sm rounded-circle"
                      src={"/assets/images/faces/face8"}
                      alt="profile"
                    />
                    <div className="wrapper ms-3">
                      <h6 className="ms-1 mb-1 text-light">David Moore</h6>
                      <small className="text-muted mb-0">
                        <i className="mdi mdi-map-marker-outline me-1"></i>
                        Arizon, USA
                      </small>
                  ...
                  <div className="wrapper d-flex align-items-center pt-2">
                    ...
                    />
                    <div className="wrapper ms-3">
                      <h6 className="ms-1 mb-1 text-light">Rafell John</h6>
                      <small className="text-muted mb-0">
                        <i className="mdi mdi-map-marker-outline me-1"></i>
                        Alaska, USA
                      </small>
