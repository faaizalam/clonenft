            ...
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-description">
                  Add class <code>.badge-&#123;color&#125;</code> with{" "}
                  <code>.badge</code>
                </p>
                  ...
                  <table className="table mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="pr-0 text-right">
                          <div className="badge badge-outline-info">Info</div>
                        </td>
                      </tr>
                      <tr>
                        <td className="ps-0">
                  ...
                  <table className="table mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td className="ps-0">Rounded Info</td>
                        <td className="pr-0 text-right">
                          <div className="badge badge-pill badge-info">5</div>
                        </td>
                      </tr>
                      <tr>
                        <td className="ps-0">Rounded Danger</td>
                        <td className="pr-0 text-right">
                          <div className="badge badge-pill badge-danger">1</div>
                        </td>
                      </tr>
                      <tr>
                        <td className="ps-0">Rounded Success</td>
                      ...
                      <tr>
                        ...
                        <td className="pr-0 text-right">
                          <div className="badge badge-pill badge-danger">
                            <i className="mdi mdi-email me-2"></i>12
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="pr-0 text-right">
                          <div className="badge badge-pill badge-success">
                            12<i className="mdi mdi-email ms-2"></i>
                          </div>
                        </td>
                      </tr>
                      <tr>
