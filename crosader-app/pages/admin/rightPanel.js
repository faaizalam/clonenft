...
export default function RightPanel ({ code: fetchedCode }){
  ...
  const saveCode = () => {
    ...
    setError(null);
    localAxios
      .post("/codes", { location: "left-panel", code })
      .then((res) => {
        setSuccess(true);
        setIsLoading(false);
      })
          ...
          <div className="card">
            <div className="card-body">
              <div className="flex justify-between items-center">
                ...
                <div className="">
                  <button onClick={() => setShowCode((oldState) => !oldState)} type="button" className="btn btn-info btn-fw">
              ...
              <div className="mt-4 flex flex-row items-stretch">
                ...
                {showPreview && (
                  <div
                    className={`${showCode ? "w-1/2 ml-4" : "w-full"
