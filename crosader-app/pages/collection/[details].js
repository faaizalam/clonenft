...
import classes from "../../component/ProjectDetails/ProjectDetails.module.scss";
...
const Details = () => {
  ...
  const heading = router.query.details?.replace(/-/g, " ");
  ...
  return (
    <div className={styleClasses}>
      ...
      <div className={classes.ProjectHeader}>
        {/* <div className="md:flex md:items-center md:ml-[30px] flex-wrap md:justify-center md:item-center md:flex-col md:w-[30%]">
              ...
              <div className="md:w-[45%] md:mr-7">
                <AttributesBox heading="Mint Details">
                  ...
                  {selectedProject.mintQuantity && (
                    <Attribute
                      name="Quantity"
                      value={selectedProject.mintQuantity}
                    />
                  )}
              ...
              <div className="md:w-[45%]">
                <AttributesBox heading="Technicals">
                  ...
                  {selectedProject.tokenomics && (
                    <Attribute
                      name="Tokenomics"
                      value={selectedProject.tokenomics}
                    />
                  )}
                  ...
                  {selectedProject.daoDetails && (
                    <Attribute
                      name="DAO Details"
                      value={selectedProject.daoDetails}
                    />
                  )}
                </AttributesBox>
              </div>
            ...
            <div className="md:w-[45%]">
              <AttributesBox heading="Socials">
                {selectedProject.websiteLink && (
                  <AttributeLink
                    name="Website"
                    link={selectedProject.websiteLink}
                  />
                )}
                {selectedProject.twitterLink && (
                  <AttributeLink
                    name="Twitter"
                    link={selectedProject.twitterLink}
                  />
                )}
                {selectedProject.discordLink && (
                  <AttributeLink
                    name="Discord"
                    link={selectedProject.discordLink}
                  />
                )}
                {selectedProject.telegramLink && (
                  <AttributeLink
                    name="Telegram"
                    link={selectedProject.telegramLink}
                  />
                )}
                {selectedProject.lootpadLink && (
                  <AttributeLink
                    name="Lootpad"
                    link={selectedProject.lootpadLink}
                  />
                )}
                ...
                {selectedProject.tiktokLink && (
                  <AttributeLink
                    name="TikTok"
                    link={selectedProject.tiktokLink}
                  />
                )}
                ...
                {selectedProject.ebLink && (
                  <AttributeLink
                    name="Ebisu's Bay"
                    link={selectedProject.ebLink}
                  />
                )}
                {selectedProject.agoraLink && (
                  <AttributeLink
                    name="Agora"
                    link={selectedProject.agoraLink}
                  />
                )}
                {selectedProject.openSea && (
                  <AttributeLink
                    name="OpenSea"
                    link={selectedProject.openSea}
                  />
                )}
